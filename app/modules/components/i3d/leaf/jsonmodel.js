        ...
        execute: function() {
            ...
            let Jsonmodel = Jsonmodel_1 = class Jsonmodel {
                ...
                mesh_geometry(jsonmodel) {
                    var loader = new THREE.ObjectLoader(), name = Object.keys(jsonmodel)[0], path = jsonmodel[name];
                    ...
                    return new Promise(function (resolve, reject) {
                        ...
                        let onload = (obj) => {
                            console.log(`ldr.onload: model=${obj}`);
                            resolve(obj);
                        };
                        let progress = (p) => {
            ...
            Jsonmodel.MODELS = {}; // cache for previously fetched models
            __decorate([
                // cache for previously fetched models
                core_1.Input(), 
