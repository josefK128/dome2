    ...
    return {
        ...
        execute: function() {
            ...
            exports_1("Scene3", Scene3 = (function () {
                'use strict';
                var scene, axes, light, key, fill, back, loader, onload, progress, onerror, 
                ...
                //  light.position.set( -1, -1, -1 );
                //  scene.add( light );
                //  light = new THREE.AmbientLight('rgb(255,165,0)');
                //  light.intensity = 0.5;
                //  scene.add( light );
