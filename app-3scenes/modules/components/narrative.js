                        ...
                        if (f) {
                            if (Array.isArray(action.a)) {
                                ...
                                if (_config_1.config.unit_test) {
                                    ...
                                    console.log(`action.f = ${action.f}`);
                                    console.log(`action.a = ${action.a}`);
                                    console.log(`key.visible = ${this.camera3d.light('key')['visible']}`);
                                    console.log(`fill.visible = ${this.camera3d.light('fill')['visible']}`);
                                    console.log(`back.visible = ${this.camera3d.light('back')['visible']}`);
                                    target[action.f](action.a);
                                }
                            }
                        }
