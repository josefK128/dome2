...
import {Tetrahedron} from '../leaf/tetrahedron';
import {Sphere} from '../leaf/sphere';
import {Cube} from '../leaf/cube';
import {Cone} from '../leaf/cone';
import {Billboard} from '../leaf/billboard';
import {Jsonmodel} from '../leaf/jsonmodel';
...
@Component({
  ...
  directives:[NgFor, NgIf, 
    Cylinder, Torus, Tetrahedron, Sphere, Cube, Cone, Billboard, Jsonmodel,
    Metaform3d],  
  providers:[]
})
