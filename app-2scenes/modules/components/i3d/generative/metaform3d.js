...
System.register(['@angular/core', '@angular/common', '../../../services/camera3d', '../leaf/cylinder', '../leaf/torus', '../leaf/tetrahedron', '../leaf/sphere', '../leaf/cube', '../leaf/cone', '../leaf/billboard', './metaform3d.html'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, common_1, camera3d_1, cylinder_1, torus_1, tetrahedron_1, sphere_1, cube_1, cone_1, billboard_1, metaform3d_html_1;
    var Metaform3d;
    return {
        setters:[
            function (core_1_1) {
            ...
            Metaform3d = Metaform3d_1 = __decorate([
                core_1.Component({
                    ...
                    directives: [common_1.NgFor, common_1.NgIf,
                        cylinder_1.Cylinder, torus_1.Torus, tetrahedron_1.Tetrahedron, sphere_1.Sphere, cube_1.Cube, cone_1.Cone, billboard_1.Billboard,
                        Metaform3d],
                    providers: []
                }), 
